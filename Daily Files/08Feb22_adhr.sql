...
--  NULL         -
--###########################################################################
SELECT * FROM (SELECT DEPTNO,SAL FROM EMP WHERE DEPTNO=10 ORDER BY DEPTNO,SAL DESC) WHERE ROWNUM<=2
UNION
SELECT * FROM (SELECT DEPTNO,SAL FROM EMP WHERE DEPTNO=20 ORDER BY DEPTNO,SAL DESC) WHERE ROWNUM<=2
UNION
SELECT * FROM (SELECT DEPTNO,SAL FROM EMP WHERE DEPTNO=30 ORDER BY DEPTNO,SAL DESC) WHERE ROWNUM<=2;